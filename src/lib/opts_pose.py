...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='multi_pose',
                             help='ctdet | ddd | multi_pose | exdet | centerface')
    ...
    self.parser.add_argument('--demo', default='/home/yangna/data/WIDER_FACE/WIDER_train/images/0--Parade/0_Parade_marchingband_1_80.jpg',
