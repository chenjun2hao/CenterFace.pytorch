...
class opts(object):
  def __init__(self, train_json='/home/yangna/deepblue/2_MOT/CenterNet/data/pig/annotations/train_pig.json', 
                     val_json='/home/yangna/deepblue/2_MOT/CenterNet/data/pig/annotations/train_pig.json'):
    self.parser = argparse.ArgumentParser()
    # basic experiment setting
    self.parser.add_argument('--task', default='ctdet',
                             help='ctdet | ddd | multi_pose | exdet')
    self.parser.add_argument('--dataset', default='pig2',
    ...
    self.parser.add_argument('--train_json', default=train_json, help='the train file labels')
    self.parser.add_argument('--val_json', default=val_json, help='the test file labels')
